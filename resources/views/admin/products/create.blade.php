                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label for="texture" class="form-label">Mô tả</label>
                                <textarea class="form-control @error('texture') is-invalid @enderror"
                                          id="texture"
                                          name="texture"
                                          rows="4">{{ old('texture') }}</textarea>
                                @error('texture')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('direction') is-invalid @enderror"
                                    ...
                                    <option value="Đông" {{ old('direction') == 'Đông' ? 'selected' : '' }}>Đông</option>
                                    <option value="Tây" {{ old('direction') == 'Tây' ? 'selected' : '' }}>Tây</option>
                                    <option value="Nam" {{ old('direction') == 'Nam' ? 'selected' : '' }}>Nam</option>
                                    <option value="Bắc" {{ old('direction') == 'Bắc' ? 'selected' : '' }}>Bắc</option>
                                    <option value="Đông Bắc" {{ old('direction') == 'Đông Bắc' ? 'selected' : '' }}>Đông Bắc</option>
                                    <option value="Đông Nam" {{ old('direction') == 'Đông Nam' ? 'selected' : '' }}>Đông Nam</option>
                                    <option value="Tây Bắc" {{ old('direction') == 'Tây Bắc' ? 'selected' : '' }}>Tây Bắc</option>
                                    <option value="Tây Nam" {{ old('direction') == 'Tây Nam' ? 'selected' : '' }}>Tây Nam</option>
                                </select>
                                @error('direction')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
